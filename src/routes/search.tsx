				...
				{isSearching && searchParam && (
					<div className={styles.resultsSection}>
						<div className={styles.profileCard}>
							<div
								className={`${styles.profileAvatar} ${animationStage >= 0 && animationStage < 5 ? styles.shimmerActive : ''}`}></div>
							<div className={styles.profileInfo}>
								<p
									className={styles.profileTitle}>{animationStage < 5 ? 'Angelina' : 'Angelina Jolie, actress, filmmaker'}</p>
						...
						<div className={styles.loadingContainer}>
							<div className={styles.loadingHeader}>
								<div className={styles.socialIcons}>
									<img src={twitterIcon} alt="Twitter/X" className={`${styles.socialIcon} ${styles.socialIconTwitter}`}/>
									<img src={linkedinIcon} alt="LinkedIn" className={`${styles.socialIcon} ${styles.socialIconLinkedIn}`}/>
									<img src={tiktokIcon} alt="TikTok" className={`${styles.socialIcon} ${styles.socialIconTikTok}`}/>
									<img src={snapchatIcon} alt="Snapchat" className={`${styles.socialIcon} ${styles.socialIconSnapchat}`}/>
									<img src={facebookIcon} alt="Facebook" className={`${styles.socialIcon} ${styles.socialIconFacebook}`}/>
								</div>
